...
export default function HomeBody() {
  ...
  const categorias = [
    {
      nombre: 'Cultivo',
      valor: preferencias[0],
      clase: cardClasses.cultivo,
      icono: iconos.cultivo,
      colorSecundario: '#6A4EBD',
    },
    {
      nombre: 'Produccion',
      valor: preferencias[1],
      clase: cardClasses.produccion,
      icono: iconos.produccion,
      colorSecundario: '#2B7BC1',
    },
    {
      nombre: 'Ventas',
      valor: preferencias[2],
      clase: cardClasses.ventas,
      icono: iconos.ventas,
      colorSecundario: '#1A9E87',
    },
  ];
