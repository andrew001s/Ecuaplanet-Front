      ...
      <View>
        <View className="rounded-3xl border flex-row m-1 p-3 items-center justify-between relative border-[#9095A0]">
          ...
          <View className="flex-1 pl-10 pr-20">
            <Text className="font-bold">Venta a {nombreCliente}</Text>
            <Text className="font-normal">{paisCliente} - {fechaVenta instanceof Date ? fechaVenta.toLocaleDateString() : fechaVenta}</Text> 
          </View>
