...
export default function TargetaHome( {nombreCliente,paisCliente,fechaVenta,montoTotalVenta}) {
  return (
      ...
      <View>
        <View className="rounded-3xl border flex-row m-1 p-3 items-center justify-between relative border-[#9095A0]">
          ...
          <View className="flex-1 pl-10 pr-20">
            ...
            <Text className="font-bold">Fecha: <Text className='font-normal'>#{fechaVenta}</Text></Text>
          </View>
