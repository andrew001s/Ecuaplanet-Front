    ...
    <View className="flex-1">
        <View className="rounded-2xl border flex-row py-4 my-1 border-[#9095A0]">
          ...
          <View className="flex-1 ">
            ...
            <Text className="font-normal text-start text-[#9095A0]">{paisCliente} {getFlagEmoji(paisCliente)} - {fechaVenta instanceof Date ? fechaVenta.toLocaleDateString() : fechaVenta}</Text> 
          </View>
